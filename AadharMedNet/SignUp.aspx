    ...
    <form id="msform" runat="server">
        ...
        <asp:Panel ID="PnlStp1" runat="server">
            <fieldset>
                ...
                <asp:TextBox runat="server" TextMode="Password" ID="TxtBxPswrd" placeholder="Password"></asp:TextBox>
                ...
                <asp:DropDownList ID="CmbBxRegAs" runat="server" Width="100%" Font-Names="Gisha" CssClass="ddl">
        ...
        <asp:Panel ID="PnlStp2" runat="server" Visible="false">
            <fieldset>
                ...
                <asp:TextBox ID="TxtBxNm" runat="server" placeholder="Name" ValidationGroup="Submit"></asp:TextBox> 
                ...
                <br />
                <br />
                <asp:TextBox ID="TxtBxAdd" runat="server" placeholder="Address" TextMode="MultiLine" ValidationGroup="Sumit"></asp:TextBox>                               
                <asp:Label ID="LblDOB" runat="server" Text="Date Of Birth"></asp:Label>
                <asp:TextBox ID="TxtBxDOB" runat="server" TextMode="Date"></asp:TextBox>                                               
