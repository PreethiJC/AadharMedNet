...
/// <summary>
/// Summary description for AadharMedNetAuthClient
/// </summary>
...
namespace AadharMedNet
{
    public class AadharMedNetAuthClient
    {
        ...
        public string buildAuthAndPost(string _uid, string _name, string _dob, string _gender)
        {
            ...
            xmlDoc.LoadXml(xml);
            using (XmlTextWriter xmltw = new XmlTextWriter(authFilePath, new UTF8Encoding(false)))
            {
            ...
            return postxmldata(signXML(authFilePath, signedFilePath)).ToString();
        }
        ...
        public XmlDocument signXML(string _orig, string _sign)
        {
            ...
            using (XmlTextWriter xmltw = new XmlTextWriter(_sign, new UTF8Encoding(false)))
            {
                doc.WriteTo(xmltw);
                xmltw.Close();
            }
